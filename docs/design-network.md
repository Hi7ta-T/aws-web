...
通信傍受の可能性を軽減させて通信の安全性を確保するため、TLSによる通信の暗号化で安全性を確保したHTTPS通信のみ受信可能とした<br>
...
だが、NAT Gatewayは通信量に応じた従量課金制のリソースであり、コスト面において最適化出来ているとは言えない。VPC Endpointへの変換は、今後の展望の中でも優先的に実施する事項である。
